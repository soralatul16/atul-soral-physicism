...
REAL eASSESSMENT QUESTION PATTERNS (from IB MYP Physics papers M23-M25):

═══ CRITERION A: KNOWING AND UNDERSTANDING ═══

Real questions follow this exact pattern:

1. A STIMULUS of 3-8 sentences describing a real-world scenario with specific details (names, places, numbers)

2. Sub-parts that escalate from recall to calculation to analysis

REAL EXAMPLE (M25 Paper, Defibrillators):

Stimulus: “Defibrillators are used to apply an electric current to the heart. Defibrillators are made from two metal plates. During a charging process, one of the plates becomes positively charged and the other becomes negatively charged.”

(a) State the name of the charged particle that moves during charging. [1 mark]

Mark scheme: “Electrons” — Award 1 mark

(b) A defibrillator delivers 150 J of energy through a potential difference of 300 V in 30 milliseconds. Calculate the current. [3 marks]

Mark scheme:

- Conversion of 30 milliseconds to 0.03 s [seen or implied]

- Use of E = VIt to find I (150 = 300 x I x 0.03) [seen or implied]

- I = 16.7 A correctly rounded to 2 or more sig figs [1 mark]

- Award 3 marks for a correctly rounded value

(c) Explain why conducting gel is applied to the skin. [1 mark]

Mark scheme: Accept any reasonable suggestion — improves conduction, reduces resistance, minimizes skin damage. Do not accept vague references.

REAL EXAMPLE (M24 Paper, Horses):

(e) A horse of weight 5100 N travels a distance of 12 m in 5.5 s. Calculate the power in kW. [3 marks]

Mark scheme:

- Calculate work done: 61200 J

- Calculate power: 11127 W

- 11.127 kW expressed to 2 or more sig figs [ECF]

KEY CRITERION A PATTERNS:

- Strand i (recall): “State”, “Outline” — 1 mark, short answer or MCQ

- Strand ii (application): “Calculate”, “Apply” — 2-3 marks, show formula then substitution then answer with units

- Strand iii (analysis): “Explain”, “Analyse” — 2-3 marks, requires reasoning

- Mark scheme format: “Award N marks”, “Seen or implied”, “Accept…”, “Do not accept…”, “WTTE”, “ECF”

- Calculations MUST specify sig fig requirements: “correctly rounded to 2 or more sig figs”

- Unit conversions MUST be shown as separate mark points: “Conversion of ms to s [seen or implied]”

═══ CRITERION B: INQUIRING AND DESIGNING ═══

Criterion B uses a HOLISTIC GRID with 5-6 rows, each scored 1-4.

REAL EXAMPLE (M25 Paper, Cotton Reel Car):

Stimulus: “A student builds a model car from a cotton reel, rubber band, stick, and pencil. After building the model car, the student turns the elastic band to wind it up and releases it.”

Question: “Design an investigation to determine how the number of turns of the elastic band affects the time the model car takes to travel a fixed distance.”

HOLISTIC GRID (this is the EXACT format — copy this structure):

Row V (Variables):

1 mark: states IV or DV

2 marks: states IV and DV

3 marks: states IV and DV and one CV

4 marks: states IV and DV and one CV with justification

Notes: “Only requirement is to state using terminology of IV, DV and CV. Do not accept ‘keeping equipment the same’ as CV.”

Row H (Hypothesis):

1 mark: links to either turns or time

2 marks: testable hypothesis links turns and time

3 marks: testable hypothesis links turns and time and explains using relevant scientific knowledge

4 marks: not used in this question

Row E (Equipment):

1 mark: stopwatch or ruler

2 marks: stopwatch and ruler to measure fixed distance

Notes: “Accept measuring tape or metre rule. Credit video analysis software as substitute for stopwatch.”

Row M (Method):

1 mark: method linked to turns or time

2 marks: method linked to turns and time but incomplete

3 marks: method linked to turns and time to travel fixed distance and can be followed

4 marks: method linked to turns and time to travel stated fixed distance and can be followed and includes details on how to control main CVs

Notes: “A method that does not include how to vary the IV is incomplete.”

Row D (Data):

1 mark: any reference to different number of turns

2 marks: at least five different numbers of turns or at least three trials

3 marks: at least five stated numbers of turns and at least three trials

4 marks: at least five stated numbers of turns and at least three trials and takes an average

Notes: “The values of the five or more variations should be explicitly stated for 3 or 4 marks”

REAL EXAMPLE (N24 Paper, LDR):

Question: “Design an investigation to determine the relationship between the distance from a light source and the resistance of an LDR.”

Same holistic grid format with rows V, CV, E, M, D.

KEY CRITERION B PATTERNS:

- Always starts with a stimulus describing equipment or a scenario

- The question asks student to DESIGN an investigation

- Grid always has V (Variables), H (Hypothesis), E (Equipment), M (Method), D (Data)

- Sometimes adds S (Safety) row: “mentions a relevant safety precaution linked to a specific hazard”

- Each row has 1-4 mark levels with increasing detail

- Notes column gives specific accept/reject guidance

═══ CRITERION C: PROCESSING AND EVALUATING ═══

Criterion C questions give students DATA and ask them to process it.

REAL EXAMPLE (N24 Paper, Resistance and Temperature):

Stimulus provides a table of temperature vs current data and asks students to:

(a) Read a value from a thermometer image [1 mark]

(b) Draw a circuit diagram [3 marks — resistor, ammeter in series, voltmeter in parallel]

(c) Identify variables as IV, DV, or CV from a table [3 marks]

(d) State a safety precaution [1 mark]

(e) Use two data points to show prediction is not supported [3 marks]

(f) Calculate resistance using R = V/I [2 marks]

(g) Plot a data point and draw line of best fit [2 marks]

(h) Read y-intercept from graph [1 mark]

(i) Calculate gradient with units [2 marks]

(j) Comment on extrapolation [1 mark]

REAL EXAMPLE (M24 Paper, Boyle’s Law):

(d) Calculate pressure increase using P = F/A [3 marks]

Mark scheme: “Correct use of (m x g) [seen or implied]. Increase in pressure = 1.52 x 10^5 Pa. Total pressure = 2.5 x 10^5 Pa [correct to at least 2 sig figs]”

(e) Describe the relationship between pressure and volume [2 marks]

Mark scheme: “As pressure increases, volume decreases. Second mark: in an inverse relationship / pressure proportional to 1/volume / when pressure doubles volume halves”

(f) Evaluate whether graph supports Boyle’s Law [2 marks]

Mark scheme: “Reference to the graph [max 1]. Justification [max 1]. Reference to the graph must be made for the first marking point.”

KEY CRITERION C PATTERNS:

- Provide REAL experimental data (table with actual numbers)

- Sub-parts progress: read data then calculate then process then graph then interpret then evaluate

- Mark schemes require specific numerical answers with units and sig figs

- Graph questions: “Plot data point correctly”, “Line of best fit appropriately models the data”

- Evaluation questions: “Reference to the graph must be made” — always require evidence

- Tables must have proper headers with units

═══ CRITERION D: REFLECTING ON THE IMPACTS ═══

Criterion D uses a HOLISTIC GRID with 3-4 theme rows plus a concluding appraisal.

REAL EXAMPLE (M25 Paper, Satellites):

Question: “Discuss the scientific and technological challenges of putting a satellite into orbit, the economic implications of private companies controlling access to the Clarke belt, and the political implications for governments of the global communication system.”

HOLISTIC GRID:

Row 1 — Scientific challenges:

1 mark: A statement

2 marks: A statement with further support OR two statements

3 marks: Two statements with further support for one

4 marks: Two statements with further support for both

Examples: “Need high thrust to overcome gravitational force”, “Need to navigate through existing satellites/space debris”

Row 2 — Economic implications:

1 mark: A positive or negative implication

2 marks: A positive and a negative implication

3 marks: A positive and negative with support for one

4 marks: A positive and negative with support for both

Examples: “Can lead to monopoly”, “Gives access for smaller companies with fewer resources”

Row 3 — Political implications:

Same 1-4 structure as above

Examples: “National security concerns”, “Countries without technology can now access satellites”

Row 4 — Concluding appraisal:

1 mark: A concluding opinion

2 marks: A concluding appraisal with justification linked to points made earlier

REAL EXAMPLE (N24 Paper, Water Access):

Three theme rows: Health benefits, Ethical advantages/disadvantages, Challenges in implementation

Plus concluding appraisal row

REAL EXAMPLE (M24 Paper, Space Telescope):

Three theme rows: Scientific challenges, Social/cultural implications, Economic implications

Plus concluding appraisal row

KEY CRITERION D PATTERNS:

- D-Factor determines the themes: Environmental, Ethical, Economic, Social, Political, Health, Scientific

- Each theme row uses the SAME progression: statement then statement with support then two with support for one then two with support for both

- The concluding appraisal ALWAYS has exactly 2 levels: opinion (1 mark) and appraisal with justification (2 marks)

- “Justification should be linked to points made earlier” — the conclusion must reference the arguments above

- Students must give BOTH benefits AND limitations / BOTH positive AND negative

- Support means a specific example or explanation, not just restating the point

- Questions always use real-world contexts: satellites, space telescopes, nuclear power, water access, defibrillators

═══ MARK SCHEME FORMAT RULES ═══

Every question must include a mark scheme. Follow these EXACT conventions from real IB mark schemes:

- “Award N mark(s) for…” — state what earns the mark

- “Seen or implied” — when a step does not need to be written explicitly

- “Accept…” — list alternative correct answers

- “Do not accept…” — list common wrong answers to reject

- “WTTE” (words to that effect) — when phrasing can vary

- “ECF” (error carried forward) — when a wrong earlier answer can still earn marks in later parts

- “[max N]” — when there are more possible answers than marks available

- “Only award mpN if mpN-1 has been awarded” — when marks are dependent

- For calculations: always specify “correctly rounded to 2 or more sig figs”
