...
function showSaveSuccess(msg, status) {
  ...
  toast.innerHTML = `
    ...
    <div style="margin-top:14px;display:flex;gap:10px;justify-content:center;flex-wrap:wrap;">
      ...
      <button onclick="window.open('exam-test.html','_blank');this.closest('#save-toast').remove();" style="background:var(--accent,#e03030);border:none;color:white;padding:8px 20px;border-radius:7px;cursor:pointer;font-family:'DM Sans',sans-serif;font-size:13px;font-weight:600;">👁 Preview as Student →</button>
